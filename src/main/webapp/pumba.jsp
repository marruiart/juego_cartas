    ...
    <main class="main-game">
      <% 
        ...
        if (start == 1) {
          ...
          game = PumbaUtilities.restartRound(game);
          message = String.format("%sComienza la ronda %d. Turno de %s (Mano).", game.removedPlayers, game.getRound(), game.getPlayerOfTurn().getPlayerName(true));
        } else {
